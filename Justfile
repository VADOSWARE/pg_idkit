...
pkg_pg_version := env_var_or_default("PKG_PG_VERSION", "18.0")
...
pgrx_pg_version := env_var_or_default("PGRX_PG_VERSION", "pg18")
...
pg_image_version := env_var_or_default("POSTGRES_IMAGE_VERSION", "18.0")
pg_os_image_version := env_var_or_default("POSTGRES_OS_IMAGE_VERSION", "alpine3.22.2")

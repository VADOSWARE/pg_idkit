...
docker run \
    ...
    -p 5432 \
    --name pg_idkit \
    ghcr.io/vadosware/pg_idkit:0.2.4-pg17.4-alpine3.21.3-amd64
```
...
- `target/release/home/<user>/.pgrx/17.4/pgrx-install/share/postgresql/extension/pg_idkit--0.2.4.sql`
...
docker run \
    ...
    -p 5432 \
    --name pg_idkit \
    ghcr.io/vadosware/pg_idkit:0.2.4-pg17.4-alpine3.18-amd64
```
